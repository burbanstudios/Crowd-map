...
# Utökad lista med svenska platser (inkl. restauranger/köpcentrum)
places = {
    ...
    "ICA Maxi Luleå": {"lat": 65.6095, "lon": 22.1351, "threshold": 90},
    "A.Ts Krog, Luleå": {"lat": 65.5849, "lon": 22.1561, "threshold": 45},
}
